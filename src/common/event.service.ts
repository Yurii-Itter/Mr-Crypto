...
export class AppEmitter extends EventEmitter {
    ...
    public readonly TELEGRAM_CRYPTOCURRENCIES_BASE: string = 'event_telegram_cryptocurrencies_base';
    public readonly TELEGRAM_CRYPTOCURRENCIES_QUOTE: string = 'event_telegram_cryptocurrencies_quote';
}